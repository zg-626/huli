 ...
 */
class TrainingLists extends BaseApiDataLists
{
    ...
    {
        $list = Training::with(['admin', 'typename'])->withCount(['signups'])->where($this->searchWhere)
    ...
    {
        return Training::where($this->queryWhere())->where($this->searchWhere)->count();
    }
