...
class AdminBase extends BaseController
{
     ...
     * @var array
     */
    protected $noNeedAuth = ['form','edit_state_same','datalist_sign_search','datalist_sign','datalist_same_study', 'serach','find','chart','datalist_same_study_search','check','export_study'];
